...
def RunML(request):
    if request.method == 'GET':
        ...
        a, p, r, f = calculateMetrics("Existing SVM Algorithm", predict, y_test)
        
        rf_cls = RandomForestClassifier()
        rf_cls.fit(X_train, y_train)
        predict = rf_cls.predict(X_test)
        a1, p1, r1, f1 = calculateMetrics("Proposed Random Forest Algorithm", predict, y_test)
        ...
        algorithms = ['Existing SVM', 'Proposed Random Forest']
        ...
        output+= "</table></br>"
        df = pd.DataFrame([['Existing SVM','Precision',p],['Existing SVM','Recall',r],['Existing SVM','F1 Score',f],['Existing SVM','Accuracy',a],
                           ['Proposed Random Forest','Precision',p1],['Proposed Random Forest','Recall',r1],['Proposed Random Forest','F1 Score',f1],['Proposed Random Forest','Accuracy',a1],
